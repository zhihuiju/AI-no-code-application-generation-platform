...
//        webDriver = initEdgeDriver(DEFAULT_WIDTH,DEFAULT_HEIGHT);
    ...
    public static String saveWebPageScreenshot(String webUrl) {
        ...
        try {
            ...
            compressIamge(imageSavePath,compressedImagePath);
    ...
    /**
     * 压缩图片
     * @param originImagePath 原路径
     * @param compressedImagePath 压缩图片路径
     */
    private static void compressIamge(String originImagePath, String compressedImagePath) {
        //压缩图片质量（0.1 = 10% 质量）
